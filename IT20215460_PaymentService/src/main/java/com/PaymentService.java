...
public class PaymentService {
	...
	public String insertPayment(@FormParam("CardNumber") String CardNumber, @FormParam("CardName") String CardName,
			@FormParam("Cvv") String Cvv, @FormParam("ExpDate") String ExpDate)
